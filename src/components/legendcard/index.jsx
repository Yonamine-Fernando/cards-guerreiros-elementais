import kaen from '/src/img/kaen.jpeg';
import mizu from '/src/img/mizu.jpeg';
import raiken from '/src/img/raiken.jpeg';
import kazetora from '/src/img/kazetora.jpeg';
import yami from '/src/img/yami.jpeg';
import gaiya from '/src/img/gaiya.jpeg';
import mestre from '/src/img/mestre.jpeg';
...
const legends = [
...

    {
        id:'kazetora',
        nome:'Kazetora',
        tipo:'Espadachim dos Ventos',
        numero:'#004',
        elemento:'Vento',
        imagem:kazetora,
        descricao:'Kazetora é um guerreiro esguio e leve como o vento, com cabelos brancos e uma capa longa que sempre esvoaça. Sua espada, “Vendaval Cortante”, parece feita de ar puro, quase invisível. Ele controla o elemento vento, usando sua espada para criar lâminas de ar, gerar ciclones e se mover rapidamente pelos campos de batalha como uma rajada de vento. Ele é mestre em ataques furtivos e evasivos, aproveitando-se da velocidade e da leveza',
    },
...

    {
        id:'gaiya',
        nome:'Gaiya',
        tipo:'Guardião da Terra',
        numero:'#006',
        elemento:'Terra',
        imagem:gaiya,
        descricao:'Gaiya é um espadachim robusto, com pele bronzeado e cabelos verde-escuro emaranhados. Sua espada, “Lâmina de Pedra”, é feita de rocha pura e brilha com runas antigas. Ela controla o elemento terra, criando barreiras de pedra, desferindo golpes devastadores que causam terremotos e manipulando o solo para prender seus oponentes. Seus ataques são lentos, mas extremamente poderosos, sendo imbatível em batalhas defensivas',
    },
